...
/**
 * AsyncDeliveryReportDetailRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     MessageMedia\RESTAPI
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 */
class AsyncDeliveryReportDetailRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $modelName = 'async_delivery_report_detail_request';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("ACCOUNT", "DESTINATION_ADDRESS", "DESTINATION_ADDRESS_COUNTRY", "FORMAT", "SOURCE_ADDRESS", "SOURCE_ADDRESS_COUNTRY", "STATUS", "STATUS_CODE", "TIMESTAMP");
    ...
    public function setSortBy($sort_by)
    {
        ...
        if (!in_array($sort_by, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'sort_by', must be one of 'ACCOUNT', 'DESTINATION_ADDRESS', 'DESTINATION_ADDRESS_COUNTRY', 'FORMAT', 'SOURCE_ADDRESS', 'SOURCE_ADDRESS_COUNTRY', 'STATUS', 'STATUS_CODE', 'TIMESTAMP'");
        }
