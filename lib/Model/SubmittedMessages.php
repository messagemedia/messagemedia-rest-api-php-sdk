...
/**
 * SubmittedMessages Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     MessageMedia\RESTAPI
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 */
class SubmittedMessages implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $modelName = 'SubmittedMessages';
    ...
    protected static $types = array(
        'messages' => '\MessageMedia\RESTAPI\Model\SubmittedMessage[]'
    );
    ...
    /**
     * Sets messages
     * @param \MessageMedia\RESTAPI\Model\SubmittedMessage[] $messages
     * @return $this
     */
