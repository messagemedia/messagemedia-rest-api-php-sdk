...
/**
 * MetadataKeysResponseProperties Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     MessageMedia\RESTAPI
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 */
class MetadataKeysResponseProperties implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $modelName = 'MetadataKeysResponse_properties';
    ...
    /**
     * Sets accounts
     * @param string[] $accounts List of accounts that were considered when fetching the metadata keys.
     * @return $this
     */
