...
/**
 * AsyncSentMessagesDetailRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     MessageMedia\RESTAPI
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 */
class AsyncSentMessagesDetailRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $modelName = 'async_sent_messages_detail_request';
    ...
    const SORT_BY_DELIVERED_TIMESTAMP = 'DELIVERED_TIMESTAMP';
    const SORT_BY_DELIVERY_REPORT = 'DELIVERY_REPORT';
    ...
    const SORT_BY_MESSAGE_EXPIRY_TIMESTAMP = 'MESSAGE_EXPIRY_TIMESTAMP';
    ...
    const SORT_BY_STATUS_CODE = 'STATUS_CODE';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("ACCOUNT", "DELIVERED_TIMESTAMP", "DELIVERY_REPORT", "DESTINATION_ADDRESS", "DESTINATION_ADDRESS_COUNTRY", "FORMAT", "MESSAGE_EXPIRY_TIMESTAMP", "SOURCE_ADDRESS", "SOURCE_ADDRESS_COUNTRY", "STATUS", "STATUS_CODE", "TIMESTAMP");
    ...
    public function setSortBy($sort_by)
    {
        ...
        if (!in_array($sort_by, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'sort_by', must be one of 'ACCOUNT', 'DELIVERED_TIMESTAMP', 'DELIVERY_REPORT', 'DESTINATION_ADDRESS', 'DESTINATION_ADDRESS_COUNTRY', 'FORMAT', 'MESSAGE_EXPIRY_TIMESTAMP', 'SOURCE_ADDRESS', 'SOURCE_ADDRESS_COUNTRY', 'STATUS', 'STATUS_CODE', 'TIMESTAMP'");
        }
    ...
    /**
     * Gets status
     * @return \MessageMedia\RESTAPI\Model\StatusBody
     */
    ...
    /**
     * Sets status
     * @param \MessageMedia\RESTAPI\Model\StatusBody $status
     * @return $this
     */
